...
export default function App() {
  ...
  const handleSelectResource = useCallback(async (resourceId) => {
    ...
    try {
      ...
      setExplanation({ resource_id: resourceId, explanation: data });
    } catch (err) {
      setExplanation({
        resource_id: resourceId,
        explanation: {
          root_cause: "Failed to load explanation",
          business_impact: err.message,
          remediation_steps: "Please try again",
